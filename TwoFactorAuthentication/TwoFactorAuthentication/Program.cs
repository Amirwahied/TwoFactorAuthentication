...
using TwoFactorAuthentication._2FA;
...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        builder.Services.AddAuthenticationServices()
                        ...
                        .AddTwoFactorAuthenticationServices()
   ...
   .AddCookie(options =>
   {
       ...
       options.AccessDeniedPath = "/User/AccessDenied";
        ...
        builder.Services.AddLogging(loggingBuilder =>
        {
            ...
            loggingBuilder.AddConsole(); // Log messages to the console
            loggingBuilder.AddDebug();   // Log messages to the debug output window
